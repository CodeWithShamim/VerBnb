    ...
    <div className="bg-grid min-h-screen">
        ...
        <div className="container-page relative z-10 max-w-4xl pb-10 pt-16 sm:pt-20">
          ...
          <Reveal delay={0.1}>
            <p className="mx-auto mt-4 max-w-xl text-center text-slate-600">
              Every dispute you raise, tracked in real time. Status and block are
              pulled live from the chain — no cached snapshots.
            </p>
          </Reveal>
          ...
          {registryUrl && (
            <Reveal delay={0.14} className="mt-5 text-center">
              ...
              >
                Registry contract: {REGISTRY_ADDRESS.slice(0, 10)}…
                {REGISTRY_ADDRESS.slice(-8)}
      ...
      <div className="container-page max-w-4xl pb-20">
        ...
        <p className="mt-6 flex items-center justify-center gap-2 text-center text-xs text-slate-400">
          ...
          Refreshing every 10 seconds — status and block read straight from
          GenLayer.
        </p>
