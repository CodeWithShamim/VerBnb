  ...
  return (
    <div className="bg-grid min-h-screen">
      <div className="container-page max-w-4xl py-14">
        {/* Hero */}
        <Reveal>
          <p className="text-xs font-semibold uppercase tracking-wide text-brand">User guide</p>
          <h1 className="mt-2 text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">
            How VerBnb works
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-slate-500">
            VerBnb settles marketplace disputes with AI validator consensus - no call centers, no
            courts, fully on-chain. Here's everything you need to use it.
          </p>
        ...
        <section className="mt-16">
          <Reveal>
            ...
            <div className="card p-6 text-slate-600">
              VerBnb resolves marketplace disputes without intermediaries. A network of AI
              validators independently fetches your evidence, applies LLM judgment, reaches
              consensus, and settles the outcome on-chain through GenLayer's Optimistic Democracy.
            </div>
          </Reveal>
        </section>
        ...
        <section className="mt-16">
          <Reveal>
            <SectionTitle kicker="Step by step" title="How to submit a dispute" />
          </Reveal>
        ...
        <section className="mt-16">
          <Reveal>
            <SectionTitle kicker="No jargon" title="What is AI consensus?" />
            <div className="card space-y-3 p-6 text-slate-600">
              <p>
                When you submit a dispute, one validator (the{' '}
                <strong className="text-slate-800">leader</strong>) reads your evidence and asks an
                AI model for a fair verdict - usually a refund percentage.
              </p>
              <p>
                Then every other validator does the same thing on their own, without seeing the
                leader's answer. If most of them land on a similar result (within 15%), the verdict
                is <strong className="text-slate-800">accepted</strong> and written to the
                blockchain. If they disagree, a new leader is picked and the round repeats.
              </p>
              <p>
                Because the answer comes from many independent AIs agreeing - not one company's
                decision - it's much harder to game.
              </p>
            </div>
          </Reveal>
        </section>
        ...
        <section className="mt-16">
          <Reveal>
            ...
            <div className="card space-y-3 p-6 text-slate-600">
              <p>
                You have <strong className="text-slate-800">7 days</strong> after a verdict
                finalizes to appeal it. Open the verdict page and click{' '}
                <strong className="text-slate-800">Appeal</strong>, give your reason, and optionally
                add new evidence.
              </p>
              <p>
